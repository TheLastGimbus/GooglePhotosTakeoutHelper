...
logger.remove() # removes the default console logger
logger.add("file_{time}.log", level="TRACE", encoding="utf8") # Unicode instructions needed to avoid file write errors.
logger.add(sys.stdout, format="{message}", level="INFO") # INFO and messages of higher priority shown on the console.
...
if __name__ == '__main__':
    try:
        ...
        logger.info(
            ...
            "Most of the times, you should cut out the last logger.infoed file to some other folder, and continue\n"
            "\n"
